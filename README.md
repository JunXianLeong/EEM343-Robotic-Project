...
This project has been divided into four tasks. For Task 3,URDF files, ROS control files and any ROS relevant file need to be created.
...
3) Python file: /grobot_trajectory_planning/src/grobot_commander.py
